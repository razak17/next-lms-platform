				...
				{track && (
					<div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
						<div className="space-y-8 lg:col-span-2">
							<Card className="rounded-sm border-0 shadow-lg">
						...
						<div className="lg:col-span-1">
							<div className="sticky top-6">
								<Card className="overflow-hidden rounded-sm border-0 shadow-xl">
...
async function EnrollButton({
	...
	if (ownsTrack) {
		return (
			<Button asChild size="lg" className="mb-6 w-full">
				<Link href={`${redirects.toDashboard}`}>Go to Dashboard</Link>
			</Button>
		);
	}
